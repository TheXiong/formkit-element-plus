...
<template>
    ...
    <FormKit ref="myForm" type="elForm" v-model="data" @submit="onClickSubmit" label-position="top">
        ...
        <FormKit type="el-array-table" name="filters" label='关联筛选器' :dynamic="true" :upControl="false"
            :downControl="false" :insertControl="false" :removeControl="true" addLabel="添加筛选器" actionWidth='200px'
            :columns="columns">
        </FormKit>
